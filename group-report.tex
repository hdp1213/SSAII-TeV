...
The primary data used to analyse the potential source candidates for the gamma rays was gathered by the Mopra Radio Telescope. Data for both carbon-12 monoxide and carbon-13 monoxide (\elem{12}{C}O and \elem{13}{C}O; see section~\ref{sec:co}) was used in data cube format, where the Doppler shift of the emission lines of the CO has been converted to relative velocity. The data cube contains several thousand frames that span \(\sim\)\unit{1000}{\kilo\meter\cdot\reciprocal\second} and are used to represent the distance to the source of the emissions.
